...
\begin{document}
	...
	\section{Approach and Methodology}
		...
		\subsection{Comparison criteria}
			...
			A typical criteria for judging the effectiveness of a test technique is the number and severity of the defects it catches (such as it is done in \cite{unit}). However, this requires studying the system over a longer period of time to uncover those defects. 
...
\bibitem{snakeoil} James Bach,{\em Test Automation Snake Oil}, http://www.satisfice.com/articles/test_automation_snake_oil.pdf, 1999 
